...
use PPStudio\Bootstrap\LegacyBootstrap;
use PPStudio\Security\SecurityFacade;

if (! function_exists('ppstudioBootstrap')) {
    function ppstudioBootstrap(): LegacyBootstrap
    {
        return LegacyBootstrap::instance();
    }
}

if (! function_exists('ppstudioSecurityFacade')) {
    function ppstudioSecurityFacade(): SecurityFacade
    {
        return ppstudioBootstrap()->securityFacade();
    }
}
