...
if (! $isAuthenticated) {
    include __DIR__ . '/includes/admin/templates/login.php';
    exit;
}
...
if ($connection instanceof mysqli) {
    ...
    foreach (\PPStudio\Http\Controller\Admin\AdminServiceController::formDataFiles(__DIR__) as $adminServiceFormDataFile) {
...
include __DIR__ . '/includes/admin/templates/app.php';
